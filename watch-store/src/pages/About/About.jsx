...
import CurrenSection from './CurrenSection'
...
const About = () => {
  const bg = 'https://your-image-link-here.jpg' // yahan apna image URL daal dein

  const breadcrumbs = [
    { label: 'Home', path: '/' },
    { label: 'Pages', path: '/loginpage' },
    { label: 'About Us' }
  ]
  ...
  return (
    ...
    <div
      ...
      style={{ backgroundImage: `url(https://demo.templatesjungle.com/elegant/images/banner-large-image2.jpg)` }}
    >
      {/* Dark overlay */}
